...
gulp.task('styles', [], function () {
    return gulp.src(yeoman.app + 'assets/css/**/*.css').pipe(gulp.dest(yeoman.tmp)).pipe(browserSync.reload({stream: true}));
});
...
gulp.task('usemin', function () {
    runSequence('images', 'styles', function () {
        return gulp.src([yeoman.app + '**/*.html', '!' + yeoman.app + 'bower_components/**/*.html']).pipe(usemin({
            css: [
                prefix.apply(),
